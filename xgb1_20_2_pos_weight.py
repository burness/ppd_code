...
all_data = pd.read_csv(save_master_factorizeV2_file_nan_log_update_ensemble, encoding='gb18030')
...
param_grid = {'silent': [1], 'nthread': [3], 'eval_metric': ['auc'], 'scale_pos_weight':[12.6487716106, 12.6587716106, 12.6687716106, 12.6787716106, 12.6887716106, 12.698771610600001, 12.708771610600001, 12.718771610600001, 12.7287716106, 12.7387716106, 12.6487716106, 12.638771610600001, 12.628771610600001, 12.618771610600001, 12.608771610600002, 12.5987716106, 12.5887716106, 12.5787716106, 12.5687716106, 12.558771610600001],
              'eta': [x * 0.002 for x in range(10)],
              'max_depth': [5, 6, 7, 8, 9, 10], 'num_round': [400, 600, 700, 800, 900,1000],
...
submission.to_csv("single_0326_3.csv", index=False)
