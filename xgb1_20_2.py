...
all_data = pd.read_csv(second_save_master_factorizeV2_file_nan_log_updateV2, encoding='gb18030')
...
param_grid = {'silent': [1], 'nthread': [3], 'eval_metric': ['auc'],
              'eta': [(1+x) * 0.002 for x in range(10)],
              'max_depth': [6, 7, 8, 9, 10], 'num_round': [1000,1200,1400,1600,1800,2000,2200],
...
submission.to_csv("single_0410.csv", index=False)
